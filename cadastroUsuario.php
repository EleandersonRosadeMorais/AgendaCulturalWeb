                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="user_type" name="user_type" class="form-select">
                            <option value="user" <?php echo $formData['user_type'] === 'user' ? 'selected' : ''; ?>>Usuário</option>
                            <option value="admin" <?php echo $formData['user_type'] === 'admin' ? 'selected' : ''; ?>>Administrador</option>
                        </select>
                    </div>
                </div>
